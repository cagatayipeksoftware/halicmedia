    ...
    setState(() {
      ...
      try {
        ...
        if(res=="success"){
          ...
          showSnackbar(context, "Etkinlik Oluşturuldu!");
          clearImage();
        }
        else{
    ...
    return _file ==null? Center(
     ...
     :   Scaffold(
        ...
        actions: [
          TextButton(
              ...
              child: const Text(
                "Oluştur!",
                style: TextStyle(
                    color: Color.fromARGB(255, 25, 1, 240),
      ...
      body: Padding(padding: EdgeInsets.only(top: 30),
        child: Column(
          children: [
            _isLoading? const LinearProgressIndicator(color:Color.fromARGB(255, 25, 1, 240) ,):const Padding(padding: EdgeInsets.only(top: 0)),
